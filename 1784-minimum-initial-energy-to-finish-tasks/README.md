<h2><a href="https://leetcode.com/problems/minimum-initial-energy-to-finish-tasks">1784. Minimum Initial Energy to Finish Tasks</a></h2><h3>Hard</h3><hr><p>You are given an array <code>tasks</code> where <code>tasks[i] = [actual<sub>i</sub>, minimum<sub>i</sub>]</code>:</p>
