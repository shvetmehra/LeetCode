<h2><a href="https://leetcode.com/problems/xor-after-range-multiplication-queries-ii">3975. XOR After Range Multiplication Queries II</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code> of length <code>n</code> and a 2D integer array <code>queries</code> of size <code>q</code>, where <code>queries[i] = [l<sub>i</sub>, r<sub>i</sub>, k<sub>i</sub>, v<sub>i</sub>]</code>.</p>
...
<ul>
	...
	<li data-end="532" data-is-last-node="" data-start="469">Finally, the XOR of all elements is <code data-end="531" data-start="505">4 ^ 18 ^ 2 ^ 15 ^ 4 = 31</code>.âââââââ<strong>âââââââ</strong></li>
</ul>
</div>
...
<ul>
	...
	<li><code>1 &lt;= q == queries.length &lt;= 10<sup>5</sup></code>âââââââ</li>
